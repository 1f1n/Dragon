...
class TronTimestampTransactions:
    ...
    def getMintTimestamp(self, contractAddress):
        ...
        url = f"https://gmgn.ai/defi/quotation/v1/tokens/tron/{contractAddress}"
        retries = 3
    ...
    def getTxByTimestamp(self, contractAddress, threads, start, end):
        base_url = f"https://gmgn.ai/defi/quotation/v1/trades/tron/{contractAddress}?limit=100"
        paginator = None
        urls = []
        all_trades = []
        ...
        wallets = []
        filename = f"Dragon/data/Tron/TimestampTxns/txns_{self.shorten(contractAddress)}__{random.randint(1111, 9999)}.txt"
